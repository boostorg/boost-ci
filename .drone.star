...
def main(ctx):
  return [
    ...
    job(compiler='clang-16',  cxxstd='11,14,17,20,2b',    os='ubuntu-24.04'),
    job(compiler='clang-17',  cxxstd='11,14,17,20,23',    os='ubuntu-24.04'),
    job(compiler='clang-18',  cxxstd='11,14,17,20,23,2c', os='ubuntu-24.04'),
    job(compiler='clang-19',  cxxstd='11,14,17,20,23,2c', os='ubuntu-24.04'),
    job(compiler='clang-20',  cxxstd='11,14,17,20,23,2c', os='ubuntu-24.04'),
    job(compiler='clang-21',  cxxstd='11,14,17,20,23,2c', os='ubuntu-26.04'),
    job(compiler='clang-22',  cxxstd='11,14,17,20,23,2c', os='ubuntu-26.04'),
    ...
    job(compiler='gcc-13',    cxxstd='11,14,17,20,2b',    os='ubuntu-24.04'),
    job(compiler='gcc-14',    cxxstd='11,14,17,20,23',    os='ubuntu-24.04'),
    job(compiler='gcc-15',    cxxstd='11,14,17,20,23,2c', os='ubuntu-26.04'),
    job(compiler='gcc-16',    cxxstd='11,14,17,20,23,26', os='ubuntu-26.04'),
